...
router.post("/register", async (req, res) => {
  const { name, email, mobile, district, year, password } = req.body;
  ...
  try {
    db.query("SELECT * FROM users WHERE email=?", [email], async (err, result) => {
      ...
      db.query(
        "INSERT INTO users (name,email,mobile,district,year,password) VALUES (?,?,?,?,?,?)",
        [name, email, mobile, district, year, hashedPassword],
        (insertErr) => {
